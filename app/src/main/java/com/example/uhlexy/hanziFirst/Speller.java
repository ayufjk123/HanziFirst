...
public class Speller extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (idioma.equals("English")) {
            ...
            tv2.setText("SHOW ENGLISH");
        } else if (idioma.equals("español")) {
            tvTopTitle.setText("  ESP:");
            tv2.setText("MOSTRAR ESPAÑOL");
        }
        //
    ...
    /**
     * Click button Show Pinyin
     *
     * @param view
     */
    public void showPinyin(View view) {
        String message = (String) tvTopPinyinTitle.getText();
        if (message.equals("  HAZ:")) {
            Toast.makeText(this, db.getKeyCharacterHanzi(n), Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(this, db.getKeyPinyin(n) + ", Tones: " + db.getKeyTone(n), Toast.LENGTH_LONG).show();
        }

    }

    /**
     * Click button Show Word
     *
     * @param view
     */
    public void showWord(View view) {
        String idioma = Locale.getDefault().getDisplayLanguage();
        if (idioma.equals("English")) {
            Toast.makeText(this, db.getKeyWordInEnglish(n), Toast.LENGTH_LONG).show();
        } else if (idioma.equals("español")) {
            Toast.makeText(this, db.getKeyWordInSpanish(n), Toast.LENGTH_LONG).show();
        }
    }
